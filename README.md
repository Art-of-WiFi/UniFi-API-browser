...
- currently, versions 4.x.x, 5.x.x, and 6.0.x of the UniFi Controller software are supported as well as UniFi OS-based controllers (version 6.4.54 has been confirmed to work)
