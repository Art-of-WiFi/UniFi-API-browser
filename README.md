## Unifi API browser
This tool is for browsing data that is accessible through Ubiquiti's Unif Controller API. Please keep the following in mind:
- not all data collections are supported (yet)
- there is still work to be done to add/improve functionality and usability of this tool so suggestions/comments are welcome. Please use github issue list or the Ubiquiti Community forums for this.
